    ...
    >
      <div className="mx-auto mt-20 w-2/3 text-center">
        ...
        <div className="mt-28 grid grid-rows-4 grid-flow-col flex-wrap">
          <div class="parent">
            <div class="div1  bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
            ...
            <div class="div2 bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
              {" "}
              <h2 className="text-4xl font-bold italic">2022</h2> <br />
              <p className="font-semibold text-2xl text-gray-700 mb-3">
            ...
            <div class="div3 bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
              {" "}
            ...
            <div class="div4 bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
              {" "}
              <h2 className="text-4xl font-bold italic">2023</h2> <br />
              <p className="font-semibold text-2xl text-gray-700 mb-3">
            ...
            <div class="div5 bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
              {" "}
            ...
            <div class="div6 bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
              {" "}
              <h2 className="text-4xl font-bold italic">2023</h2> <br />
              <p className="font-semibold text-2xl text-gray-700 mb-3">
            ...
            <div class="div7 bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
              {" "}
              <h2 className="text-4xl font-bold italic">2023</h2> <br />
              <p className="font-semibold text-2xl text-gray-700 mb-3">
            ...
            <div class="div8 bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
              {" "}
            ...
            <div class="div9 bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
              {" "}
              <h2 className="text-4xl font-bold italic">2023</h2> <br />
              <p className="font-semibold text-2xl text-gray-700 mb-3">
            ...
            <div class="div10 bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
              {" "}
              <h2 className="text-4xl font-bold italic">2023</h2> <br />
              <p className="font-semibold text-2xl text-gray-700 mb-3">
            ...
            <div class="div11 bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
              {" "}
              <h2 className="text-4xl font-bold italic">2023</h2> <br />
              <p className="font-semibold text-2xl text-gray-700 mb-3">
                CURSO CSS
            ...
            <div class="div12 bg-white bg-opacity-50 p-1 md:p-8 md:ml-12 md:w-6/12 lg:w-50 md:shadow-lg cursor-pointer">
              {" "}
              <h2 className="text-4xl font-bold italic">2023</h2> <br />
              <p className="font-semibold text-2xl text-gray-700 mb-3">
                Introducción a UX
